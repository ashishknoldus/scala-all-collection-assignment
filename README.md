# scala-all-collection-assignment

### Authors : Akhil Vijayan and Ashish Tomer
...
Special Attention: Please create a project with name scala-all-collection-assignments and create the README.md file in git repo by putting this two question into it.
